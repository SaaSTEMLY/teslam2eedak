...
export function BlogFilters({ translations: m, categories }: BlogFiltersProps) {
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
        ...
        >
          ...
          <SelectContent>
            ...
            <SelectItem value="oldest">{m.sortOldest}</SelectItem>
            <SelectItem value="title_asc">{m.sortTitleAsc}</SelectItem>
          </SelectContent>
        </Select>
      </div>
