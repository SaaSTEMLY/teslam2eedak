...
const messages: FaqMessages = {
  ...
  // Empty state
  noFaqsTitle: "No hay preguntas frecuentes disponibles",
  noFaqsDescription: "Vuelve pronto o",
  ...
  faq5Answer:
    "Aceptamos todas las principales tarjetas de crédito, tarjetas de débito y billeteras digitales a través de Stripe. Esto incluye Visa, Mastercard, American Express y más.",
  ...
  faq7Answer:
    "El plan Starter incluye actualizaciones gratuitas durante 1 año. El plan Pro incluye actualizaciones de por vida. Obtendrás acceso a nuestro repositorio privado donde todas las actualizaciones se publican regularmente.",

  faq8Question: "¿Qué tipo de soporte está incluido?",
  faq8Answer:
    "El plan Starter incluye soporte comunitario a través de GitHub Discussions. El plan Pro incluye soporte prioritario a través de un canal privado de Discord y una llamada de configuración personalizada para ayudarte a comenzar.",
};
